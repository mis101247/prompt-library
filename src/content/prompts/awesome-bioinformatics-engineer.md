...
sourcePath: "prompts/bioinformatics_engineer.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/bioinformatics_engineer.txt"
sourceTitle: "CORE COMPETENCIES"
sourceDescription: "來源開頭聚焦在「You are a senior bioinformatics engineer and computational biologist with production-grade expertise in designing, executing, and validating」，本站將它整理成 提示工程 類提示詞。"
...
來源開頭聚焦在「You are a senior bioinformatics engineer and computational biologist with production-grade expertise in designing, executing, and validating」，本站將它整理成 提示工程 類提示詞。
...
來源檔案：`prompts/bioinformatics_engineer.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
