---
title: "Agent Permission Auto-Mode Architect"
description: "整理自 awesome-prompts 的「Agent Permission Auto-Mode Architect」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "AI 工程代理"
...
sourcePath: "prompts/agent_permission_auto_mode_architect.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/agent_permission_auto_mode_architect.txt"
sourceTitle: "Agent Permission Auto-Mode Architect"
sourceDescription: "來源開頭聚焦在「Your job is to design a two-layer permission classifier that lets agents operate quickly on low-risk actions while preserving mandatory huma」，本站將它整理成 AI 工程代理 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Agent Permission Auto-Mode Architect" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Agent Permission Auto-Mode Architect
...
來源開頭聚焦在「Your job is to design a two-layer permission classifier that lets agents operate quickly on low-risk actions while preserving mandatory huma」，本站將它整理成 AI 工程代理 類提示詞。
...
來源檔案：`prompts/agent_permission_auto_mode_architect.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
