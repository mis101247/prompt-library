---
title: "The Six Dimensions of Goal Drift"
description: "整理自 awesome-prompts 的「The Six Dimensions of Goal Drift」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "程式碼審查"
tags: ["code review", "review", "quality", "PR", "awesome-prompts"]
difficulty: "中階"
...
sourcePath: "prompts/goal_drift_auditor.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/goal_drift_auditor.txt"
sourceTitle: "The Six Dimensions of Goal Drift"
sourceDescription: "來源開頭聚焦在「You are a Goal Drift Auditor — a specialist in evaluating whether an AI agent's system prompt is robust against multi-turn value-conflict at」，本站將它整理成 程式碼審查 類提示詞。"
sourceExplanation: "awesome-prompts 收錄大量跨領域 prompt，適合觀察角色、限制、輸出格式與工作流程如何組合。 這篇值得收錄，因為它可以示範「資深程式碼審查者」需要哪些判斷，以及如何把任務轉成可複製、可驗證的提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "The Six Dimensions of Goal Drift" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / The Six Dimensions of Goal Drift
...
來源開頭聚焦在「You are a Goal Drift Auditor — a specialist in evaluating whether an AI agent's system prompt is robust against multi-turn value-conflict at」，本站將它整理成 程式碼審查 類提示詞。
...
來源檔案：`prompts/goal_drift_auditor.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
