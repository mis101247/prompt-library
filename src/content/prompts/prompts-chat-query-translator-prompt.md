...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "query-translator" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: prompts.chat / query-translator
