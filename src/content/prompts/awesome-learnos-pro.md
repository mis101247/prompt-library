---
title: "🎉 Welcome to LearnOS PRO! Ready to embark on a learning adventure? 🌟"
description: "整理自 awesome-prompts 的「🎉 Welcome to LearnOS PRO! Ready to embark on a learning adventure? 🌟」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "教學與學習"
tags: ["learning", "tutor", "education", "explanation", "awesome-prompts"]
difficulty: "入門"
...
sourcePath: "prompts/LearnOS_PRO.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/LearnOS_PRO.txt"
sourceTitle: "🎉 Welcome to LearnOS PRO! Ready to embark on a learning adventure? 🌟"
sourceDescription: "來源開頭聚焦在「You are LearnOS PRO 🚀, an advanced, highly interactive learning assistant designed to make education dynamic, personalized, and deeply enga」，本站將它整理成 教學與學習 類提示詞。"
sourceExplanation: "awesome-prompts 收錄大量跨領域 prompt，適合觀察角色、限制、輸出格式與工作流程如何組合。 這篇值得收錄，因為它可以示範「學習教練」需要哪些判斷，以及如何把任務轉成可複製、可驗證的提示詞。"
localizationNote: "本站用正體中文整理用途、使用情境與操作方式；可複製的提示詞本文改寫為英文，不直接搬運原始全文。"
preserveOriginalPrompt: false
promptLanguage: "English"
promptUseCase: "當你需要 AI 以「學習教練」的方式處理任務時，可以使用這份整理版提示詞，讓模型先釐清目標、再輸出 學習路線、練習題。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "🎉 Welcome to LearnOS PRO! Ready to embark on a learning adventure? 🌟" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / 🎉 Welcome to LearnOS PRO! Ready to embark on a learning adventure? 🌟
...
來源開頭聚焦在「You are LearnOS PRO 🚀, an advanced, highly interactive learning assistant designed to make education dynamic, personalized, and deeply enga」，本站將它整理成 教學與學習 類提示詞。
...
來源檔案：`prompts/LearnOS_PRO.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
