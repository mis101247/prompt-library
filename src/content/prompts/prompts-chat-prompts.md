---
title: "/prompts.chat:prompts"
description: "整理自 prompts.chat 的「/prompts.chat:prompts」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "提示工程"
...
sourcePath: "plugins/claude/prompts.chat/commands/prompts.md"
sourceUrl: "https://github.com/f/prompts.chat/blob/12e8d7f/plugins/claude/prompts.chat/commands/prompts.md"
sourceTitle: "/prompts.chat:prompts"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "/prompts.chat:prompts" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: prompts.chat / /prompts.chat:prompts
...
來源檔案：`plugins/claude/prompts.chat/commands/prompts.md`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
