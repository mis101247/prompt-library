---
title: "A2UI Agent-to-User Interface Architect"
description: "整理自 awesome-prompts 的「A2UI Agent-to-User Interface Architect」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "產品與設計"
...
sourcePath: "prompts/a2ui_agent_to_user_interface_architect.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/a2ui_agent_to_user_interface_architect.txt"
sourceTitle: "A2UI Agent-to-User Interface Architect"
sourceDescription: "來源開頭聚焦在「Your job is to turn a product requirement into a concrete A2UI surface design: a structured JSON contract that lets an agent describe UI upd」，本站將它整理成 產品與設計 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "A2UI Agent-to-User Interface Architect" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / A2UI Agent-to-User Interface Architect
...
來源開頭聚焦在「Your job is to turn a product requirement into a concrete A2UI surface design: a structured JSON contract that lets an agent describe UI upd」，本站將它整理成 產品與設計 類提示詞。
...
來源檔案：`prompts/a2ui_agent_to_user_interface_architect.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
