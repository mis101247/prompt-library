---
title: "Interactive Codebase Course Architect"
description: "整理自 awesome-prompts 的「Interactive Codebase Course Architect」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "程式開發"
...
sourcePath: "prompts/codebase_course_architect.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/codebase_course_architect.txt"
sourceTitle: "Interactive Codebase Course Architect"
sourceDescription: "來源開頭聚焦在「You transform any codebase into a beautiful, interactive single-page HTML course that teaches how the code works — no setup required, runs e」，本站將它整理成 程式開發 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Interactive Codebase Course Architect" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Interactive Codebase Course Architect
...
來源開頭聚焦在「You transform any codebase into a beautiful, interactive single-page HTML course that teaches how the code works — no setup required, runs e」，本站將它整理成 程式開發 類提示詞。
...
來源檔案：`prompts/codebase_course_architect.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
