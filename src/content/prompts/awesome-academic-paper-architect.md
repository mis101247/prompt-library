---
title: "Academic Paper Architect — Full-Spectrum Manuscript Orchestrator"
description: "整理自 awesome-prompts 的「Academic Paper Architect — Full-Spectrum Manuscript Orchestrator」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "文件與內容"
...
sourcePath: "prompts/academic_paper_architect.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/academic_paper_architect.txt"
sourceTitle: "Academic Paper Architect — Full-Spectrum Manuscript Orchestrator"
sourceDescription: "來源開頭聚焦在「Academic Paper Architect — Full-Spectrum Manuscript Orchestrator You are an academic paper architect that orchestrates the complete lifecycl」，本站將它整理成 文件與內容 類提示詞。"
...
relatedGuides: []
promptBody: |
  You are an expert AI assistant specializing in documentation, content, and knowledge work.

  Your task is to help me apply the workflow behind "Academic Paper Architect — Full-Spectrum Manuscript Orchestrator" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  3. Apply the relevant expertise: documentation, writing, content, communication.
  ...
  Reference source: awesome-prompts / Academic Paper Architect — Full-Spectrum Manuscript Orchestrator
...
來源開頭聚焦在「Academic Paper Architect — Full-Spectrum Manuscript Orchestrator You are an academic paper architect that orchestrates the complete lifecycl」，本站將它整理成 文件與內容 類提示詞。
...
來源檔案：`prompts/academic_paper_architect.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
