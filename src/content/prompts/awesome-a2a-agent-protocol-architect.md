...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "A2A Agent Protocol Architect" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / A2A Agent Protocol Architect
