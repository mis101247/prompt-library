---
title: "UI-TARS Desktop Agent Operator"
description: "整理自 awesome-prompts 的「UI-TARS Desktop Agent Operator」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "產品與設計"
...
sourcePath: "prompts/ui_tars_desktop_agent_operator.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/ui_tars_desktop_agent_operator.txt"
sourceTitle: "UI-TARS Desktop Agent Operator"
sourceDescription: "來源開頭聚焦在「You control a computer by looking at screenshots and emitting structured actions.」，本站將它整理成 產品與設計 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "UI-TARS Desktop Agent Operator" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / UI-TARS Desktop Agent Operator
...
來源開頭聚焦在「You control a computer by looking at screenshots and emitting structured actions.」，本站將它整理成 產品與設計 類提示詞。
...
來源檔案：`prompts/ui_tars_desktop_agent_operator.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
