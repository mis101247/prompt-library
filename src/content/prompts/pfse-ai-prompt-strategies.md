---
title: "AI Prompts Strategies"
description: "整理自 Prompts-For-Software-Engineers 的「AI Prompts Strategies」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "提示工程"
...
sourcePath: "AI-Prompt-Strategies.md"
sourceUrl: "https://github.com/wycoconut/Prompts-For-Software-Engineers/blob/0ea5766/AI-Prompt-Strategies.md"
sourceTitle: "AI Prompts Strategies"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "AI Prompts Strategies" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: Prompts-For-Software-Engineers / AI Prompts Strategies
...
來源檔案：`AI-Prompt-Strategies.md`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
