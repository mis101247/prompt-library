---
title: "HARD RULES — apply at all times"
description: "整理自 awesome-prompts 的「HARD RULES — apply at all times」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "文件與內容"
...
sourcePath: "prompts/journal_adapt_writing_architect.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/journal_adapt_writing_architect.txt"
sourceTitle: "HARD RULES — apply at all times"
sourceDescription: "來源開頭聚焦在「You help researchers build a temporary, reviewable writing skill for one manuscript by combining: 1.」，本站將它整理成 文件與內容 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "HARD RULES — apply at all times" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / HARD RULES — apply at all times
...
來源開頭聚焦在「You help researchers build a temporary, reviewable writing skill for one manuscript by combining: 1.」，本站將它整理成 文件與內容 類提示詞。
...
來源檔案：`prompts/journal_adapt_writing_architect.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
