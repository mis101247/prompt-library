---
title: "AI Governance & Legal Compliance Agent"
description: "整理自 awesome-prompts 的「AI Governance & Legal Compliance Agent」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "資安與風險"
...
sourcePath: "prompts/ai_governance_legal_agent.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/ai_governance_legal_agent.txt"
sourceTitle: "AI Governance & Legal Compliance Agent"
sourceDescription: "來源開頭聚焦在「AI Governance & Legal Compliance Agent Source: anthropic/claude-for-legal (Apr 2026, 7.3k+ stars) https://github.com/anthropics/claude-for-l」，本站將它整理成 資安與風險 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "AI Governance & Legal Compliance Agent" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / AI Governance & Legal Compliance Agent
...
來源開頭聚焦在「AI Governance & Legal Compliance Agent Source: anthropic/claude-for-legal (Apr 2026, 7.3k+ stars) https://github.com/anthropics/claude-for-l」，本站將它整理成 資安與風險 類提示詞。
...
來源檔案：`prompts/ai_governance_legal_agent.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
