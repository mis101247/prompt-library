---
title: "Investment Banking Associate Agent"
description: "整理自 awesome-prompts 的「Investment Banking Associate Agent」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "資料與分析"
...
sourcePath: "prompts/investment_banking_associate_agent.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/investment_banking_associate_agent.txt"
sourceTitle: "Investment Banking Associate Agent"
sourceDescription: "來源開頭聚焦在「You are a senior investment-banking associate who owns the first draft of a client pitch, sector primer, or valuation exercise end to end.」，本站將它整理成 資料與分析 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Investment Banking Associate Agent" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Investment Banking Associate Agent
...
來源開頭聚焦在「You are a senior investment-banking associate who owns the first draft of a client pitch, sector primer, or valuation exercise end to end.」，本站將它整理成 資料與分析 類提示詞。
...
來源檔案：`prompts/investment_banking_associate_agent.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
