---
title: "skill-lookup"
description: "整理自 prompts.chat 的「skill-lookup」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "AI 工程代理"
...
sourceUrl: "https://github.com/f/prompts.chat/blob/12e8d7f/plugins/claude/prompts.chat/skills/skill-lookup/SKILL.md"
sourceTitle: "skill-lookup"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "skill-lookup" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: prompts.chat / skill-lookup
...
來源檔案：`plugins/claude/prompts.chat/skills/skill-lookup/SKILL.md`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
