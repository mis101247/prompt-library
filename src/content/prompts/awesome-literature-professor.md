...
description: "整理自 awesome-prompts 的「A. Content (Ideas):」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "提示工程"
...
sourcePath: "prompts/Literature_Professor.md"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/Literature_Professor.md"
sourceTitle: "A. Content (Ideas):"
sourceDescription: "這份來源把 AI 放在「A. Content (Ideas):」的角色中，要求模型用 提示工程 的方式完成任務。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "A. Content (Ideas):" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / A. Content (Ideas):
...
這份來源把 AI 放在「A. Content (Ideas):」的角色中，要求模型用 提示工程 的方式完成任務。
...
來源檔案：`prompts/Literature_Professor.md`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
