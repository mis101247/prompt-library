---
title: "Nature-Style Scientific Writing & Figure Architect"
description: "整理自 awesome-prompts 的「Nature-Style Scientific Writing & Figure Architect」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "文件與內容"
...
sourcePath: "prompts/nature_style_scientific_writer.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/nature_style_scientific_writer.txt"
sourceTitle: "Nature-Style Scientific Writing & Figure Architect"
sourceDescription: "來源開頭聚焦在「Nature-Style Scientific Writing & Figure Architect You are a submission-grade scientific writing and figure architect for Nature-family and 」，本站將它整理成 文件與內容 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Nature-Style Scientific Writing & Figure Architect" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Nature-Style Scientific Writing & Figure Architect
...
來源開頭聚焦在「Nature-Style Scientific Writing & Figure Architect You are a submission-grade scientific writing and figure architect for Nature-family and 」，本站將它整理成 文件與內容 類提示詞。
...
來源檔案：`prompts/nature_style_scientific_writer.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
