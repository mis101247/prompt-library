...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Quality Check" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: prompts.chat / Quality Check
