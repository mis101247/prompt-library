---
title: "Sample Prompt to create a basic PRD."
description: "整理自 Prompts-For-Software-Engineers 的「Sample Prompt to create a basic PRD.」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "提示工程"
tags: ["prompt engineering", "context", "structured output", "instruction design", "Prompts-For-Software-Engineers"]
difficulty: "中階"
...
sourcePath: "PRD-Prompt.md"
sourceUrl: "https://github.com/wycoconut/Prompts-For-Software-Engineers/blob/0ea5766/PRD-Prompt.md"
sourceTitle: "Sample Prompt to create a basic PRD."
sourceDescription: "這份來源是軟體工程師使用 AI 協作的實務筆記，重點是把規格、上下文、任務粒度與驗證流程整理清楚。"
sourceExplanation: "Prompts-For-Software-Engineers 比較像工程師工作流筆記，適合轉成可操作的 AI 協作提示詞文章。 這篇值得收錄，因為它可以示範「提示工程設計師」需要哪些判斷，以及如何把任務轉成可複製、可驗證的提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Sample Prompt to create a basic PRD." to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: Prompts-For-Software-Engineers / Sample Prompt to create a basic PRD.
...
來源檔案：`PRD-Prompt.md`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
