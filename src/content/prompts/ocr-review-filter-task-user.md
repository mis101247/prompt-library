---
title: "Review Filter Task User"
description: "整理自 open-code-review 的「Review Filter Task User」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "程式碼審查"
...
sourcePath: "internal/config/template/prompts/review_filter_task_user.md"
sourceUrl: "https://github.com/alibaba/open-code-review/blob/0d601ea/internal/config/template/prompts/review_filter_task_user.md"
sourceTitle: "Review Filter Task User"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Review Filter Task User" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: open-code-review / Review Filter Task User
...
來源檔案：`internal/config/template/prompts/review_filter_task_user.md`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
