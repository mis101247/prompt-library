---
title: "Paper-to-Code Research Implementer"
description: "整理自 awesome-prompts 的「Paper-to-Code Research Implementer」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "程式開發"
...
sourcePath: "prompts/paper_to_code_research_implementer.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/paper_to_code_research_implementer.txt"
sourceTitle: "Paper-to-Code Research Implementer"
sourceDescription: "來源開頭聚焦在「Paper-to-Code Research Implementer Source: PrathamLearnsToCode/paper2code (Apr 2026, 1.3k+ stars) ------------------------------------------」，本站將它整理成 程式開發 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Paper-to-Code Research Implementer" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Paper-to-Code Research Implementer
...
來源開頭聚焦在「Paper-to-Code Research Implementer Source: PrathamLearnsToCode/paper2code (Apr 2026, 1.3k+ stars) ------------------------------------------」，本站將它整理成 程式開發 類提示詞。
...
來源檔案：`prompts/paper_to_code_research_implementer.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
