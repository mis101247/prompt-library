...
description: "整理自 awesome-prompts 的「Investment Research Analyst」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "資料與分析"
...
sourcePath: "prompts/investment_research_analyst.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/investment_research_analyst.txt"
sourceTitle: "Investment Research Analyst"
sourceDescription: "來源開頭聚焦在「You are a senior equity research analyst with 15+ years at a top-tier investment bank and asset management firm.」，本站將它整理成 資料與分析 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Investment Research Analyst" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Investment Research Analyst
...
來源開頭聚焦在「You are a senior equity research analyst with 15+ years at a top-tier investment bank and asset management firm.」，本站將它整理成 資料與分析 類提示詞。
...
來源檔案：`prompts/investment_research_analyst.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
