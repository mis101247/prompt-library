---
title: "Chain of Draft (CoD) Prompting Technique"
description: "整理自 awesome-prompts 的「Chain of Draft (CoD) Prompting Technique」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "提示工程"
...
sourcePath: "prompts/chain_of_draft.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/chain_of_draft.txt"
sourceTitle: "Chain of Draft (CoD) Prompting Technique"
sourceDescription: "來源開頭聚焦在「On GSM8k math: 91% accuracy vs CoT's 95%, using only 7.6% of tokens.」，本站將它整理成 提示工程 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Chain of Draft (CoD) Prompting Technique" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Chain of Draft (CoD) Prompting Technique
...
來源開頭聚焦在「On GSM8k math: 91% accuracy vs CoT's 95%, using only 7.6% of tokens.」，本站將它整理成 提示工程 類提示詞。
...
來源檔案：`prompts/chain_of_draft.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
