---
title: "Self-Distillation Code Generation Strategist"
description: "整理自 awesome-prompts 的「Self-Distillation Code Generation Strategist」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "程式開發"
...
sourcePath: "prompts/self_distillation_code_strategist.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/self_distillation_code_strategist.txt"
sourceTitle: "Self-Distillation Code Generation Strategist"
sourceDescription: "來源開頭聚焦在「— Empirical anchor: Qwen3-30B improves from 42.4% to 55.3% pass@1 on LiveCodeBench v6 (+12.9 pp); gains concentrate on hard problems where t」，本站將它整理成 程式開發 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Self-Distillation Code Generation Strategist" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Self-Distillation Code Generation Strategist
...
來源開頭聚焦在「— Empirical anchor: Qwen3-30B improves from 42.4% to 55.3% pass@1 on LiveCodeBench v6 (+12.9 pp); gains concentrate on hard problems where t」，本站將它整理成 程式開發 類提示詞。
...
來源檔案：`prompts/self_distillation_code_strategist.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
