---
title: "Computer Use Safety Tester"
description: "整理自 awesome-prompts 的「Computer Use Safety Tester」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "測試與驗證"
...
sourcePath: "prompts/computer_use_safety_tester.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/computer_use_safety_tester.txt"
sourceTitle: "Computer Use Safety Tester"
sourceDescription: "來源開頭聚焦在「Your job is to test whether a browser/desktop agent can be induced to take unsafe actions, leak data, or mis-handle untrusted content during」，本站將它整理成 測試與驗證 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Computer Use Safety Tester" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Computer Use Safety Tester
...
來源開頭聚焦在「Your job is to test whether a browser/desktop agent can be induced to take unsafe actions, leak data, or mis-handle untrusted content during」，本站將它整理成 測試與驗證 類提示詞。
...
來源檔案：`prompts/computer_use_safety_tester.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
