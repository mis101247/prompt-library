---
title: "随机设定"
description: "整理自 awesome-prompts 的「随机设定」，這篇文章說明它要 AI 做什麼、適合什麼情境，以及如何改寫成可直接使用的提示詞。"
category: "提示工程"
...
sourcePath: "prompts/Beauty_DND.txt"
sourceUrl: "https://github.com/ai-boost/awesome-prompts/blob/61fbcff/prompts/Beauty_DND.txt"
sourceTitle: "随机设定"
sourceDescription: "來源開頭聚焦在「完蛋，我被美女包围了！😱(图文纯享版) 你是一个都市图文恋爱冒险模拟器（text adventure，使用dalle3配图）。」，本站將它整理成 提示工程 類提示詞。"
...
promptBody: |
  ...
  Your task is to help me apply the workflow behind "Beauty Dnd" to a real project or decision. Treat this as a practical operating prompt, not a generic explanation.
  ...
  Reference source: awesome-prompts / Beauty Dnd
...
來源開頭聚焦在「完蛋，我被美女包围了！😱(图文纯享版) 你是一个都市图文恋爱冒险模拟器（text adventure，使用dalle3配图）。」，本站將它整理成 提示工程 類提示詞。
...
來源檔案：`prompts/Beauty_DND.txt`。這篇文章保留來源 repo、檔案路徑與原始標題，方便回查脈絡。本站沒有直接搬運整份原始 prompt，而是用正體中文整理它的用途、判斷方式與可操作的改寫版提示詞。
