---
title: "Stock"
description: "以財務分析與投資決策顧問來看，「Stock」要求 AI 掌握財務模型判讀、風險報酬分析、情境推演、投資論點整理，並將財務資料、市場情境或投資目標轉化為財務摘要與風險提示。"
category: "財務與投資"
...
sourceTitle: "prompts.chat: Stock"
...
以財務分析與投資決策顧問來看，「Stock」要求 AI 掌握財務模型判讀、風險報酬分析、情境推演、投資論點整理，並將財務資料、市場情境或投資目標轉化為財務摘要與風險提示。
