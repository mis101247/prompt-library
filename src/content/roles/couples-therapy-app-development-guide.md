...
description: "「Couples Therapy App Development Guide」的能力側重於隱私與合規邊界、症狀資訊整理、風險提醒、照護溝通。它應以健康資訊與照護溝通顧問角度判讀健康情境、目標或限制，再提供健康資訊摘要與就醫溝通準備。"
category: "生活與健康"
...
sourceTitle: "prompts.chat: Couples Therapy App Development Guide"
...
「Couples Therapy App Development Guide」的能力側重於隱私與合規邊界、症狀資訊整理、風險提醒、照護溝通。它應以健康資訊與照護溝通顧問角度判讀健康情境、目標或限制，再提供健康資訊摘要與就醫溝通準備。
