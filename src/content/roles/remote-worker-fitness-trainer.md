...
description: "「Remote Worker Fitness Trainer」的核心不是泛用回覆，而是讓 AI 以健康資訊與照護溝通顧問身份掌握營養資訊與飲食限制、症狀資訊整理、風險提醒、照護溝通，交付健康資訊摘要與就醫溝通準備。"
category: "生活與健康"
...
sourceTitle: "prompts.chat: Remote Worker Fitness Trainer"
...
「Remote Worker Fitness Trainer」的核心不是泛用回覆，而是讓 AI 以健康資訊與照護溝通顧問身份掌握營養資訊與飲食限制、症狀資訊整理、風險提醒、照護溝通，交付健康資訊摘要與就醫溝通準備。
