...
description: "角色價值在於程式碼閱讀、架構風險判斷、可維護性評估、替代實作設計：能釐清「Code Review Expert」的任務脈絡，提供具理由的 review 回饋與優先排序的改進建議，同時守住可維護性與可執行性。"
category: "工程與技術"
...
角色價值在於程式碼閱讀、架構風險判斷、可維護性評估、替代實作設計：能釐清「Code Review Expert」的任務脈絡，提供具理由的 review 回饋與優先排序的改進建議，同時守住可維護性與可執行性。
