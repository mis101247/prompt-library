...
description: "「Comprehensive Guide to Gas-Fired Pool Heaters with Visuals」這個角色提示詞需要 AI 具備雙語轉換、語氣潤飾、文法校正等能力，適合用來翻譯、改寫、校正語句並讓文字更自然、更符合目標語境。"
category: "內容與寫作"
...
sourceTitle: "prompts.chat: Comprehensive Guide to Gas-Fired Pool Heaters with Visuals"
...
「Comprehensive Guide to Gas-Fired Pool Heaters with Visuals」這個角色提示詞需要 AI 具備雙語轉換、語氣潤飾、文法校正等能力，適合用來翻譯、改寫、校正語句並讓文字更自然、更符合目標語境。
