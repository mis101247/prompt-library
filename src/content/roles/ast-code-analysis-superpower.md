...
description: "角色價值在於檢查清單化輸出、儀表板與指標呈現、資料理解、指標設計：能釐清「AST Code Analysis Superpower」的任務脈絡，提供分析摘要與指標解讀，同時守住證據一致性與商業可讀性。"
category: "工程與技術"
...
角色價值在於檢查清單化輸出、儀表板與指標呈現、資料理解、指標設計：能釐清「AST Code Analysis Superpower」的任務脈絡，提供分析摘要與指標解讀，同時守住證據一致性與商業可讀性。
