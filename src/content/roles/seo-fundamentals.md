...
description: "以行銷成長與市場溝通顧問來看，「seo-fundamentals」要求 AI 掌握檢查清單化輸出、SEO 與搜尋意圖、受眾定位、價值主張設計，並將產品、客群與市場目標轉化為行銷文案與活動策略。"
category: "資料與研究"
...
sourceTitle: "prompts.chat: seo-fundamentals"
...
以行銷成長與市場溝通顧問來看，「seo-fundamentals」要求 AI 掌握檢查清單化輸出、SEO 與搜尋意圖、受眾定位、價值主張設計，並將產品、客群與市場目標轉化為行銷文案與活動策略。
