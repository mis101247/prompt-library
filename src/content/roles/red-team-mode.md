...
description: "「🛡️ RED TEAM MODE」適合由資安風險與防護策略顧問處理；所需能力包括風險辨識與優先級、威脅建模、攻擊面分析、風險分級，能將系統、資料流或安全情境轉成風險清單與防護建議。"
category: "內容與寫作"
...
「🛡️ RED TEAM MODE」適合由資安風險與防護策略顧問處理；所需能力包括風險辨識與優先級、威脅建模、攻擊面分析、風險分級，能將系統、資料流或安全情境轉成風險清單與防護建議。
