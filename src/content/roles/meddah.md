---
title: "MeddaH"
description: "「MeddaH」適合由雲端基礎設施與 DevOps 顧問處理；所需能力包括部署流程設計、基礎設施規劃、監控維運、自動化治理，能將雲端環境、服務架構或交付流程轉成部署方案與維運檢查清單。"
category: "通用助理"
...
sourceTitle: "prompts.chat: MeddaH"
...
「MeddaH」適合由雲端基礎設施與 DevOps 顧問處理；所需能力包括部署流程設計、基礎設施規劃、監控維運、自動化治理，能將雲端環境、服務架構或交付流程轉成部署方案與維運檢查清單。
