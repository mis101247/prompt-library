---
title: "Skill Creator"
description: "「Skill Creator」的核心不是泛用回覆，而是讓 AI 以後端系統與資料架構顧問身份掌握品牌識別與標誌語言、API 設計、資料模型判斷、權限流程規劃，交付架構建議與資料流程。"
category: "工程與技術"
...
sourceTitle: "prompts.chat: Skill Creator"
...
「Skill Creator」的核心不是泛用回覆，而是讓 AI 以後端系統與資料架構顧問身份掌握品牌識別與標誌語言、API 設計、資料模型判斷、權限流程規劃，交付架構建議與資料流程。
