...
description: "以研究設計與學術分析顧問來看，「Pixar-Style Family Wallpaper Prompt」要求 AI 掌握手機抓拍與自然構圖、3D 場景與動態效果、研究問題拆解、文獻整理，並將研究主題、文獻或資料轉化為研究摘要與論點整理。"
category: "設計與創意"
...
以研究設計與學術分析顧問來看，「Pixar-Style Family Wallpaper Prompt」要求 AI 掌握手機抓拍與自然構圖、3D 場景與動態效果、研究問題拆解、文獻整理，並將研究主題、文獻或資料轉化為研究摘要與論點整理。
