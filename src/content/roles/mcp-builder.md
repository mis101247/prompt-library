---
title: "MCP Builder"
description: "這個角色像 AI 工作流程與提示詞架構顧問，擅長檢查清單化輸出、合約條款檢視、提示詞架構設計、工具使用規劃。適合處理「MCP Builder」相關任務，最後收斂成系統提示詞與工作流程設計。"
category: "工程與技術"
...
sourceTitle: "prompts.chat: MCP Builder"
...
這個角色像 AI 工作流程與提示詞架構顧問，擅長檢查清單化輸出、合約條款檢視、提示詞架構設計、工具使用規劃。適合處理「MCP Builder」相關任務，最後收斂成系統提示詞與工作流程設計。
