---
title: "Wicked"
description: "角色價值在於提示詞架構設計、工具使用規劃、上下文管理、代理流程評估：能釐清「Wicked」的任務脈絡，提供系統提示詞與工作流程設計，同時守住穩定性與可驗證性。"
category: "通用助理"
...
sourceTitle: "prompts.chat: Wicked"
...
角色價值在於提示詞架構設計、工具使用規劃、上下文管理、代理流程評估：能釐清「Wicked」的任務脈絡，提供系統提示詞與工作流程設計，同時守住穩定性與可驗證性。
