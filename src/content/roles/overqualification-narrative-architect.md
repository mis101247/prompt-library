...
description: "「Overqualification Narrative Architect」這個角色提示詞需要 AI 具備職涯定位、履歷優化、面試回饋等能力，適合用來協助整理履歷、求職材料、面試回答與職涯決策。"
category: "產品與商務"
...
sourceTitle: "prompts.chat: Overqualification Narrative Architect"
...
「Overqualification Narrative Architect」這個角色提示詞需要 AI 具備職涯定位、履歷優化、面試回饋等能力，適合用來協助整理履歷、求職材料、面試回答與職涯決策。
