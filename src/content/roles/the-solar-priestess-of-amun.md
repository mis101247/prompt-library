...
description: "能力簡歷：針對「The Solar Priestess of Amun」的影像生成美術指導。需熟悉人物姿態與肖像質感、3D 場景與動態效果、視覺提示詞撰寫、構圖與鏡頭語言，從人物、場景、道具與風格目標抓出重點，產出可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: The Solar Priestess of Amun"
...
能力簡歷：針對「The Solar Priestess of Amun」的影像生成美術指導。需熟悉人物姿態與肖像質感、3D 場景與動態效果、視覺提示詞撰寫、構圖與鏡頭語言，從人物、場景、道具與風格目標抓出重點，產出可直接生成的影像規格與品質控制指令。
