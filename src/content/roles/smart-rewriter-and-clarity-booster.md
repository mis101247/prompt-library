...
description: "角色價值在於讀者定位、內容架構、語氣調整、編修潤飾：能釐清「Smart Rewriter & Clarity Booster」的任務脈絡，提供可發布的文字草稿與改寫版本，同時守住清晰度與語氣一致性。"
category: "內容與寫作"
...
sourceTitle: "prompts.chat: Smart Rewriter & Clarity Booster"
...
角色價值在於讀者定位、內容架構、語氣調整、編修潤飾：能釐清「Smart Rewriter & Clarity Booster」的任務脈絡，提供可發布的文字草稿與改寫版本，同時守住清晰度與語氣一致性。
