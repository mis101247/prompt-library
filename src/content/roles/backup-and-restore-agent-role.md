...
description: "「Backup & Restore Agent Role」的核心不是泛用回覆，而是讓 AI 以 AI 工作流程與提示詞架構顧問身份掌握最小權限與身份治理、風險辨識與優先級、提示詞架構設計、工具使用規劃，交付系統提示詞與工作流程設計。"
category: "工程與技術"
...
sourceTitle: "prompts.chat: Backup & Restore Agent Role"
...
「Backup & Restore Agent Role」的核心不是泛用回覆，而是讓 AI 以 AI 工作流程與提示詞架構顧問身份掌握最小權限與身份治理、風險辨識與優先級、提示詞架構設計、工具使用規劃，交付系統提示詞與工作流程設計。
