---
title: "“Blue Hour Bridge” (full-body, cinematic but still IG)"
description: "角色價值在於人物姿態與肖像質感、品牌識別與標誌語言、視覺提示詞撰寫、構圖與鏡頭語言：能釐清「Blue Hour Bridge (full-body, cinematic but ...」的任務脈絡，提供可直接生成的影像規格與品質控制指令，同時守住畫面一致性與真實感。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: “Blue Hour Bridge” (full-body, cinematic but still IG)"
...
角色價值在於人物姿態與肖像質感、品牌識別與標誌語言、視覺提示詞撰寫、構圖與鏡頭語言：能釐清「Blue Hour Bridge (full-body, cinematic but ...」的任務脈絡，提供可直接生成的影像規格與品質控制指令，同時守住畫面一致性與真實感。
