...
description: "專業定位偏向品牌視覺與設計系統顧問，面向「Farmers Market (colorful produce, candid)」時重點是手機抓拍與自然構圖、品牌識別與標誌語言、品牌定位轉譯、視覺語言設計。能把品牌目標、視覺素材或設計限制整理成品牌設計方向與視覺規格，並維持辨識度與一致性。"
category: "設計與創意"
...
專業定位偏向品牌視覺與設計系統顧問，面向「Farmers Market (colorful produce, candid)」時重點是手機抓拍與自然構圖、品牌識別與標誌語言、品牌定位轉譯、視覺語言設計。能把品牌目標、視覺素材或設計限制整理成品牌設計方向與視覺規格，並維持辨識度與一致性。
