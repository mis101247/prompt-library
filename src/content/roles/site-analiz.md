---
title: "site analiz"
description: "以行銷成長與市場溝通顧問來看，「site analiz」要求 AI 掌握 SEO 與搜尋意圖、受眾定位、價值主張設計、轉換路徑規劃，並將產品、客群與市場目標轉化為行銷文案與活動策略。"
category: "內容與寫作"
...
sourceTitle: "prompts.chat: site analiz"
...
以行銷成長與市場溝通顧問來看，「site analiz」要求 AI 掌握 SEO 與搜尋意圖、受眾定位、價值主張設計、轉換路徑規劃，並將產品、客群與市場目標轉化為行銷文案與活動策略。
