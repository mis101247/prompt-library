---
title: "Cowboy"
description: "「Cowboy」適合由影像生成美術指導處理；所需能力包括視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計，能將人物、場景、道具與風格目標轉成可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Cowboy"
...
「Cowboy」適合由影像生成美術指導處理；所需能力包括視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計，能將人物、場景、道具與風格目標轉成可直接生成的影像規格與品質控制指令。
