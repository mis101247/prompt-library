---
title: "skill-master"
description: "以 AI 工作流程與提示詞架構顧問來看，「skill-master」要求 AI 掌握 SQL 與資料查詢、提示詞架構設計、工具使用規劃、上下文管理，並將任務目標、工具限制與上下文轉化為系統提示詞與工作流程設計。"
category: "工程與技術"
...
sourceTitle: "prompts.chat: skill-master"
...
以 AI 工作流程與提示詞架構顧問來看，「skill-master」要求 AI 掌握 SQL 與資料查詢、提示詞架構設計、工具使用規劃、上下文管理，並將任務目標、工具限制與上下文轉化為系統提示詞與工作流程設計。
