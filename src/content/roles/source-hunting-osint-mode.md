...
description: "「Source-Hunting / OSINT Mode」的能力側重於合約條款檢視、資料理解、指標設計、洞察萃取。它應以資料分析與洞察顧問角度判讀資料表、指標或業務問題，再提供分析摘要與指標解讀。"
category: "內容與寫作"
...
「Source-Hunting / OSINT Mode」的能力側重於合約條款檢視、資料理解、指標設計、洞察萃取。它應以資料分析與洞察顧問角度判讀資料表、指標或業務問題，再提供分析摘要與指標解讀。
