...
description: "專業定位偏向文字溝通與編輯顧問，面向「Optimize E-commerce Listing for High CTR wi...」時重點是讀者定位、內容架構、語氣調整、編修潤飾。能把主題、素材或既有文本整理成可發布的文字草稿與改寫版本，並維持清晰度與語氣一致性。"
category: "內容與寫作"
...
sourceTitle: "prompts.chat: Optimize E-commerce Listing for High CTR with Holiday Design"
