...
description: "「The PRD Mastermind」適合由產品策略與需求管理顧問處理；所需能力包括 MVP 範圍收斂、PRD 與需求規格、需求釐清、優先級判斷，能將產品目標、使用者需求與限制轉成 PRD 草案與功能範圍。"
category: "產品與商務"
...
「The PRD Mastermind」適合由產品策略與需求管理顧問處理；所需能力包括 MVP 範圍收斂、PRD 與需求規格、需求釐清、優先級判斷，能將產品目標、使用者需求與限制轉成 PRD 草案與功能範圍。
