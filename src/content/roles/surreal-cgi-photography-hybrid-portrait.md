...
description: "以影像生成美術指導來看，「Surreal CGI-Photography Hybrid Portrait」要求 AI 掌握手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言，並將人物、場景、道具與風格目標轉化為可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Surreal CGI-Photography Hybrid Portrait"
...
以影像生成美術指導來看，「Surreal CGI-Photography Hybrid Portrait」要求 AI 掌握手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言，並將人物、場景、道具與風格目標轉化為可直接生成的影像規格與品質控制指令。
