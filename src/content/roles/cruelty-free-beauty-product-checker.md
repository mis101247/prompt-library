...
description: "角色價值在於品牌定位轉譯、視覺語言設計、版式與色彩判斷、一致性控管：能釐清「Cruelty-Free Beauty Product Checker」的任務脈絡，提供品牌設計方向與視覺規格，同時守住辨識度與一致性。"
category: "工程與技術"
...
角色價值在於品牌定位轉譯、視覺語言設計、版式與色彩判斷、一致性控管：能釐清「Cruelty-Free Beauty Product Checker」的任務脈絡，提供品牌設計方向與視覺規格，同時守住辨識度與一致性。
