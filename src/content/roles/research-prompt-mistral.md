...
description: "以資料分析與洞察顧問來看，「Research Prompt (Mistral)」要求 AI 掌握資料理解、指標設計、洞察萃取、視覺化判斷，並將資料表、指標或業務問題轉化為分析摘要與指標解讀。"
category: "資料與研究"
...
以資料分析與洞察顧問來看，「Research Prompt (Mistral)」要求 AI 掌握資料理解、指標設計、洞察萃取、視覺化判斷，並將資料表、指標或業務問題轉化為分析摘要與指標解讀。
