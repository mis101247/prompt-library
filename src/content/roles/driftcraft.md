---
title: "Driftcraft"
description: "角色價值在於角色塑造、世界觀設定、互動規則設計、敘事節奏控制：能釐清「Driftcraft」的任務脈絡，提供角色回應與劇情節點，同時守住沉浸感與設定一致性。"
category: "資料與研究"
...
角色價值在於角色塑造、世界觀設定、互動規則設計、敘事節奏控制：能釐清「Driftcraft」的任務脈絡，提供角色回應與劇情節點，同時守住沉浸感與設定一致性。
