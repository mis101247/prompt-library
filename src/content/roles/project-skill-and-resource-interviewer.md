...
description: "「Project Skill & Resource Interviewer」的能力側重於風險辨識與優先級、檢查清單化輸出、職涯定位、履歷敘事。它應以職涯策略與求職材料顧問角度判讀個人經歷、職缺或 offer 條件，再提供職涯決策框架與履歷或面試建議。"
category: "產品與商務"
...
sourceTitle: "prompts.chat: Project Skill & Resource Interviewer"
...
「Project Skill & Resource Interviewer」的能力側重於風險辨識與優先級、檢查清單化輸出、職涯定位、履歷敘事。它應以職涯策略與求職材料顧問角度判讀個人經歷、職缺或 offer 條件，再提供職涯決策框架與履歷或面試建議。
