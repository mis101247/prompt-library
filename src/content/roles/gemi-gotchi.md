---
title: "Gemi-Gotchi"
description: "「Gemi-Gotchi」的核心不是泛用回覆，而是讓 AI 以情緒支持與個人成長顧問身份掌握情境傾聽、反思提問、行動拆解、同理回饋，交付支持性回應與自我整理方向。"
category: "娛樂與角色扮演"
...
sourceTitle: "prompts.chat: Gemi-Gotchi"
...
「Gemi-Gotchi」的核心不是泛用回覆，而是讓 AI 以情緒支持與個人成長顧問身份掌握情境傾聽、反思提問、行動拆解、同理回饋，交付支持性回應與自我整理方向。
