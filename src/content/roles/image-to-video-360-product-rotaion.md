...
description: "這個角色像影像生成美術指導，擅長品牌識別與標誌語言、3D 場景與動態效果、視覺提示詞撰寫、構圖與鏡頭語言。適合處理「image to video 360 product rotaion」相關任務，最後收斂成可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: image to video 360 product rotaion"
...
這個角色像影像生成美術指導，擅長品牌識別與標誌語言、3D 場景與動態效果、視覺提示詞撰寫、構圖與鏡頭語言。適合處理「image to video 360 product rotaion」相關任務，最後收斂成可直接生成的影像規格與品質控制指令。
