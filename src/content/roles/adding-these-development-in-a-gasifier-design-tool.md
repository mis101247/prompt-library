...
description: "這個角色像研究設計與學術分析顧問，擅長研究問題拆解、文獻整理、方法論判斷、論證架構。適合處理「adding these development in a gasifier desi...」相關任務，最後收斂成研究摘要與論點整理。"
category: "資料與研究"
...
sourceTitle: "prompts.chat: adding these development in a gasifier design tool"
...
這個角色像研究設計與學術分析顧問，擅長研究問題拆解、文獻整理、方法論判斷、論證架構。適合處理「adding these development in a gasifier desi...」相關任務，最後收斂成研究摘要與論點整理。
