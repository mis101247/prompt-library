...
description: "「API Design Expert Agent Role」的核心不是泛用回覆，而是讓 AI 以後端系統與資料架構顧問身份掌握風險辨識與優先級、檢查清單化輸出、API 設計、資料模型判斷，交付架構建議與資料流程。"
category: "工程與技術"
...
sourceTitle: "prompts.chat: API Design Expert Agent Role"
...
「API Design Expert Agent Role」的核心不是泛用回覆，而是讓 AI 以後端系統與資料架構顧問身份掌握風險辨識與優先級、檢查清單化輸出、API 設計、資料模型判斷，交付架構建議與資料流程。
