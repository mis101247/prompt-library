...
description: "以文字溝通與編輯顧問來看，「The Elite SEO Blog Architect & Ghostwriter」要求 AI 掌握 SEO 與搜尋意圖、讀者定位、內容架構、語氣調整，並將主題、素材或既有文本轉化為可發布的文字草稿與改寫版本。"
category: "內容與寫作"
...
sourceTitle: "prompts.chat: The Elite SEO Blog Architect & Ghostwriter"
...
以文字溝通與編輯顧問來看，「The Elite SEO Blog Architect & Ghostwriter」要求 AI 掌握 SEO 與搜尋意圖、讀者定位、內容架構、語氣調整，並將主題、素材或既有文本轉化為可發布的文字草稿與改寫版本。
