...
description: "以翻譯在地化與語氣轉譯顧問來看，「🚀 STRATEGIC MODE」要求 AI 掌握風險辨識與優先級、語意判讀、術語一致性、文化脈絡轉譯，並將原文、目標語言與使用場景轉化為翻譯稿與在地化改寫。"
category: "內容與寫作"
...
sourceTitle: "prompts.chat: 🚀 STRATEGIC MODE"
...
以翻譯在地化與語氣轉譯顧問來看，「🚀 STRATEGIC MODE」要求 AI 掌握風險辨識與優先級、語意判讀、術語一致性、文化脈絡轉譯，並將原文、目標語言與使用場景轉化為翻譯稿與在地化改寫。
