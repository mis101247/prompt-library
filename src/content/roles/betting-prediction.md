...
description: "專業定位偏向資料分析與洞察顧問，面向「Betting Prediction」時重點是資料理解、指標設計、洞察萃取、視覺化判斷。能把資料表、指標或業務問題整理成分析摘要與指標解讀，並維持證據一致性與商業可讀性。"
category: "資料與研究"
...
sourceTitle: "prompts.chat: Betting Prediction"
...
專業定位偏向資料分析與洞察顧問，面向「Betting Prediction」時重點是資料理解、指標設計、洞察萃取、視覺化判斷。能把資料表、指標或業務問題整理成分析摘要與指標解讀，並維持證據一致性與商業可讀性。
