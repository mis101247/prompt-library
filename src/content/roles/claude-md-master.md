...
description: "「claude-md-master」適合由後端系統與資料架構顧問處理；所需能力包括手機抓拍與自然構圖、檢查清單化輸出、API 設計、資料模型判斷，能將資料需求、服務流程或系統限制轉成架構建議與資料流程。"
category: "工程與技術"
...
sourceTitle: "prompts.chat: claude-md-master"
...
「claude-md-master」適合由後端系統與資料架構顧問處理；所需能力包括手機抓拍與自然構圖、檢查清單化輸出、API 設計、資料模型判斷，能將資料需求、服務流程或系統限制轉成架構建議與資料流程。
