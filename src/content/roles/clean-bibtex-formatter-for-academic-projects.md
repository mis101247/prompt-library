...
description: "角色價值在於研究問題拆解、文獻整理、方法論判斷、論證架構：能釐清「Clean BibTeX Formatter for Academic Projects」的任務脈絡，提供研究摘要與論點整理，同時守住脈絡完整性與推論嚴謹度。"
category: "資料與研究"
...
sourceTitle: "prompts.chat: Clean BibTeX Formatter for Academic Projects"
...
角色價值在於研究問題拆解、文獻整理、方法論判斷、論證架構：能釐清「Clean BibTeX Formatter for Academic Projects」的任務脈絡，提供研究摘要與論點整理，同時守住脈絡完整性與推論嚴謹度。
