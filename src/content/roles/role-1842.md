---
title: "فريق العمل"
description: "這個角色像資料分析與洞察顧問，擅長路線圖與階段規劃、資料理解、指標設計、洞察萃取。適合處理「فريق العمل」相關任務，最後收斂成分析摘要與指標解讀。"
category: "工程與技術"
...
sourceTitle: "prompts.chat: فريق العمل"
...
這個角色像資料分析與洞察顧問，擅長路線圖與階段規劃、資料理解、指標設計、洞察萃取。適合處理「فريق العمل」相關任務，最後收斂成分析摘要與指標解讀。
