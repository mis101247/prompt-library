...
description: "能力簡歷：針對「Virtual Game Console Simulator」的互動敘事與遊戲內容設計顧問。需熟悉隱私與合規邊界、角色塑造、世界觀設定、互動規則設計，從角色、場景或遊戲目標抓出重點，產出角色回應與劇情節點。"
category: "娛樂與角色扮演"
...
sourceTitle: "prompts.chat: Virtual Game Console Simulator"
