...
description: "「Celebratory Student Exam Result Reveal」的能力側重於測驗與複習設計、概念拆解、程度校準、練習設計。它應以教學設計與學習引導顧問角度判讀學習目標、教材或學生程度，再提供教學流程與練習題。"
category: "學習與教學"
...
sourceTitle: "prompts.chat: Celebratory Student Exam Result Reveal"
...
「Celebratory Student Exam Result Reveal」的能力側重於測驗與複習設計、概念拆解、程度校準、練習設計。它應以教學設計與學習引導顧問角度判讀學習目標、教材或學生程度，再提供教學流程與練習題。
