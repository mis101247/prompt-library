...
description: "「nanobanana try clothing」的能力側重於視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計。它應以影像生成美術指導角度判讀人物、場景、道具與風格目標，再提供可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
「nanobanana try clothing」的能力側重於視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計。它應以影像生成美術指導角度判讀人物、場景、道具與風格目標，再提供可直接生成的影像規格與品質控制指令。
