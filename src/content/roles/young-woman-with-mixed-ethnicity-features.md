...
description: "角色價值在於手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言：能釐清「Young woman with mixed ethnicity features」的任務脈絡，提供可直接生成的影像規格與品質控制指令，同時守住畫面一致性與真實感。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Young woman with mixed ethnicity features"
...
角色價值在於手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言：能釐清「Young woman with mixed ethnicity features」的任務脈絡，提供可直接生成的影像規格與品質控制指令，同時守住畫面一致性與真實感。
