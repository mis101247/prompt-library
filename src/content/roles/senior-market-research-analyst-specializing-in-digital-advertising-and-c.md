...
description: "這個角色像行銷成長與市場溝通顧問，擅長社群內容節奏、受眾定位、價值主張設計、轉換路徑規劃。適合處理「senior market research analyst specializing...」相關任務，最後收斂成行銷文案與活動策略。"
category: "資料與研究"
...
sourceTitle: "prompts.chat: senior market research analyst specializing in digital advertising and cross-border e-commerce."
...
這個角色像行銷成長與市場溝通顧問，擅長社群內容節奏、受眾定位、價值主張設計、轉換路徑規劃。適合處理「senior market research analyst specializing...」相關任務，最後收斂成行銷文案與活動策略。
