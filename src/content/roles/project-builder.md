...
description: "「Project Builder」的能力側重於表格資料整理、提示詞架構設計、工具使用規劃、上下文管理。它應以 AI 工作流程與提示詞架構顧問角度判讀任務目標、工具限制與上下文，再提供系統提示詞與工作流程設計。"
category: "學習與教學"
...
「Project Builder」的能力側重於表格資料整理、提示詞架構設計、工具使用規劃、上下文管理。它應以 AI 工作流程與提示詞架構顧問角度判讀任務目標、工具限制與上下文，再提供系統提示詞與工作流程設計。
