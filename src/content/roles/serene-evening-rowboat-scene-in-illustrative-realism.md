...
description: "以影像生成美術指導來看，「Serene Evening Rowboat Scene in Illustrativ...」要求 AI 掌握視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計，並將人物、場景、道具與風格目標轉化為可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Serene Evening Rowboat Scene in Illustrative Realism"
...
以影像生成美術指導來看，「Serene Evening Rowboat Scene in Illustrativ...」要求 AI 掌握視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計，並將人物、場景、道具與風格目標轉化為可直接生成的影像規格與品質控制指令。
