...
description: "能力簡歷：針對「Planjedor de Tarefas」的產品策略與需求管理顧問。需熟悉需求釐清、優先級判斷、使用者故事設計、路線圖規劃，從產品目標、使用者需求與限制抓出重點，產出 PRD 草案與功能範圍。"
category: "工程與技術"
...
能力簡歷：針對「Planjedor de Tarefas」的產品策略與需求管理顧問。需熟悉需求釐清、優先級判斷、使用者故事設計、路線圖規劃，從產品目標、使用者需求與限制抓出重點，產出 PRD 草案與功能範圍。
