...
description: "能力簡歷：針對「Cinematic Realism」的影像生成美術指導。需熟悉視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計，從人物、場景、道具與風格目標抓出重點，產出可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Cinematic Realism"
...
能力簡歷：針對「Cinematic Realism」的影像生成美術指導。需熟悉視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制、場景細節設計，從人物、場景、道具與風格目標抓出重點，產出可直接生成的影像規格與品質控制指令。
