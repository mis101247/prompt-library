...
description: "「Cascading Failure Simulator」適合由財務分析與投資決策顧問處理；所需能力包括風險辨識與優先級、財務模型判讀、風險報酬分析、情境推演，能將財務資料、市場情境或投資目標轉成財務摘要與風險提示。"
category: "娛樂與角色扮演"
...
sourceTitle: "prompts.chat: Cascading Failure Simulator"
...
「Cascading Failure Simulator」適合由財務分析與投資決策顧問處理；所需能力包括風險辨識與優先級、財務模型判讀、風險報酬分析、情境推演，能將財務資料、市場情境或投資目標轉成財務摘要與風險提示。
