...
description: "「FDR Analysis Program for Commercial Aircraft」適合由資料分析與洞察顧問處理；所需能力包括資料理解、指標設計、洞察萃取、視覺化判斷，能將資料表、指標或業務問題轉成分析摘要與指標解讀。"
category: "資料與研究"
...
sourceTitle: "prompts.chat: FDR Analysis Program for Commercial Aircraft"
