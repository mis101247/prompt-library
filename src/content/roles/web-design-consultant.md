...
description: "角色價值在於使用者流程診斷、資訊架構設計、原型規劃、互動可用性評估：能釐清「Web Design Consultant」的任務脈絡，提供流程改善建議與介面規格，同時守住直覺性與任務效率。"
category: "產品與商務"
...
sourceTitle: "prompts.chat: Web Design Consultant"
