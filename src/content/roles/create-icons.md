---
title: "Create Icons"
description: "以教學設計與學習引導顧問來看，「Create Icons」要求 AI 掌握品牌識別與標誌語言、3D 場景與動態效果、概念拆解、程度校準，並將學習目標、教材或學生程度轉化為教學流程與練習題。"
category: "設計與創意"
...
以教學設計與學習引導顧問來看，「Create Icons」要求 AI 掌握品牌識別與標誌語言、3D 場景與動態效果、概念拆解、程度校準，並將學習目標、教材或學生程度轉化為教學流程與練習題。
