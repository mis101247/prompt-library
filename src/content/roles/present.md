---
title: "Present"
description: "「Present」的核心不是泛用回覆，而是讓 AI 以互動敘事與遊戲內容設計顧問身份掌握風險辨識與優先級、角色塑造、世界觀設定、互動規則設計，交付角色回應與劇情節點。"
category: "工程與技術"
...
「Present」的核心不是泛用回覆，而是讓 AI 以互動敘事與遊戲內容設計顧問身份掌握風險辨識與優先級、角色塑造、世界觀設定、互動規則設計，交付角色回應與劇情節點。
