...
description: "「Photorealistic Mirror Selfie Analysis」適合由影像生成美術指導處理；所需能力包括手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言，能將人物、場景、道具與風格目標轉成可直接生成的影像規格與品質控制指令。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Photorealistic Mirror Selfie Analysis"
...
「Photorealistic Mirror Selfie Analysis」適合由影像生成美術指導處理；所需能力包括手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言，能將人物、場景、道具與風格目標轉成可直接生成的影像規格與品質控制指令。
