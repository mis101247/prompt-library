---
title: "gemini.md"
description: "專業定位偏向互動敘事與遊戲內容設計顧問，面向「gemini.md」時重點是風險辨識與優先級、角色塑造、世界觀設定、互動規則設計。能把角色、場景或遊戲目標整理成角色回應與劇情節點，並維持沉浸感與設定一致性。"
category: "工程與技術"
...
專業定位偏向互動敘事與遊戲內容設計顧問，面向「gemini.md」時重點是風險辨識與優先級、角色塑造、世界觀設定、互動規則設計。能把角色、場景或遊戲目標整理成角色回應與劇情節點，並維持沉浸感與設定一致性。
