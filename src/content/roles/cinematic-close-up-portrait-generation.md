...
description: "專業定位偏向影像生成美術指導，面向「Cinematic Close-Up Portrait Generation」時重點是人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制。能把人物、場景、道具與風格目標整理成可直接生成的影像規格與品質控制指令，並維持畫面一致性與真實感。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Cinematic Close-Up Portrait Generation"
...
專業定位偏向影像生成美術指導，面向「Cinematic Close-Up Portrait Generation」時重點是人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制。能把人物、場景、道具與風格目標整理成可直接生成的影像規格與品質控制指令，並維持畫面一致性與真實感。
