...
description: "角色價值在於 3D 場景與動態效果、視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制：能釐清「Hyper-Realistic 3D Isometric Ottoman Master...」的任務脈絡，提供可直接生成的影像規格與品質控制指令，同時守住畫面一致性與真實感。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Hyper-Realistic 3D Isometric Ottoman Masterpiece"
...
角色價值在於 3D 場景與動態效果、視覺提示詞撰寫、構圖與鏡頭語言、光線質感控制：能釐清「Hyper-Realistic 3D Isometric Ottoman Master...」的任務脈絡，提供可直接生成的影像規格與品質控制指令，同時守住畫面一致性與真實感。
