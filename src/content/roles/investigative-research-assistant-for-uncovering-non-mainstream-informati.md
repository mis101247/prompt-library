...
description: "「Investigative Research Assistant for Uncovering Non-Mainstream Information」這個角色提示詞需要 AI 具備研究問題拆解、文獻整理、論證架構等能力，適合用來拆解研究問題、整理文獻與論點，產出有脈絡的學術分析或研究摘要。"
category: "資料與研究"
...
sourceTitle: "prompts.chat: Investigative Research Assistant for Uncovering Non-Mainstream Information"
...
「Investigative Research Assistant for Uncovering Non-Mainstream Information」這個角色提示詞需要 AI 具備研究問題拆解、文獻整理、論證架構等能力，適合用來拆解研究問題、整理文獻與論點，產出有脈絡的學術分析或研究摘要。
