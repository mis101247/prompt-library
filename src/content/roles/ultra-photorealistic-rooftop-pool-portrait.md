...
description: "專業定位偏向影像生成美術指導，面向「Ultra Photorealistic Rooftop Pool Portrait」時重點是手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言。能把人物、場景、道具與風格目標整理成可直接生成的影像規格與品質控制指令，並維持畫面一致性與真實感。"
category: "設計與創意"
...
sourceTitle: "prompts.chat: Ultra Photorealistic Rooftop Pool Portrait"
...
專業定位偏向影像生成美術指導，面向「Ultra Photorealistic Rooftop Pool Portrait」時重點是手機抓拍與自然構圖、人物姿態與肖像質感、視覺提示詞撰寫、構圖與鏡頭語言。能把人物、場景、道具與風格目標整理成可直接生成的影像規格與品質控制指令，並維持畫面一致性與真實感。
